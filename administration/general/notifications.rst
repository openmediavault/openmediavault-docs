...
.. note::
	Gmail requires "access for less secure applications" to be enabled, in order for OpenMediaVault to send notifications using ``smtp.gmail.com``.  `Enable access for less secure applications <https://myaccount.google.com/lesssecureapps>`_ ::         
