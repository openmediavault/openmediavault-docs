# -*- coding: utf-8 -*-
#
# openmediavault-wiki documentation build configuration file, created by
...
# ones.
extensions = ['sphinx_fontawesome','myst_parser']
...
project = u'openmediavault'
copyright = u'2018 and onwards by the authors'
author = u'openmediavault team and contributors'
...
# of the sidebar.
html_logo = '_static/images/openmediavault.svg'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/images/openmediavault.ico'
