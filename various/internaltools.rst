...
.. note::
	What each does function and the parameters it accepts is documented in the `file <https://github.com/openmediavault/openmediavault/blob/master/deb/openmediavault/usr/share/openmediavault/scripts/helper-functions>`_ .
